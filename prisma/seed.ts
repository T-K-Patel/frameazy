    ...
    for (let i = 1; i < 101; i++) {
        await prisma.frame.upsert({
            ...
            create: {
                ...
                borderSrc:"https://s3-alpha-sig.figma.com/img/ab02/0fa4/f61635b8dbfc67d9759c2504146ee176?Expires=1724630400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=dS8ESuC~z3q47J-M7ukCNoghEchTU01lPoohOx0r7~vk3e2RYOGHTUFTN~FZrHJ3IpNMIEBPqf9DCKmiDm7Vq~-~LCL7qDcxhQ7-wHig0sWpNWo2SPp7sE~h9ydHF-~DEnMMj25sEf3x0Hlgx~kUrs-RK-fYfvZ0NVzq~CYGMlOWGZ4HhwPKXlpL9GowE0anzBPZfoCzH2BgC~eFkGqFGZ1C24Zr9I5PQslxECq-8P~V35oZUYy8YcPCJ7i6ICvuJU51U4HyVrx3TqjFml~3OgKhboZCDfTJsqIjZESf9fqb4QrzKYWtANJsM80qYAFBupE4XKTgxr1XY0I-zORY5Q__"            
            },
        });
    }
}
