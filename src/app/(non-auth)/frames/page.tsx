        ...
        <>
            <ul className="flex flex-col gap-y-1">
                ...
                {Object.values(Category).map((category) => {
                    ...
                    return <Checkbox checked={isChecked} key={category} title={category} onChange={(checked:boolean)=>{
                        if(checked){
            ...
            <ul className="flex flex-col gap-y-1">
                ...
                {Object.values(Collection).map((collection) => {
                    ...
                    return <Checkbox checked={isChecked} key={collection} title={collection} onChange={(checked:boolean)=>{
                        if(checked){
                            setFilters((originalFilters) => {
                                return {
                                    ...originalFilters,
            ...
            <ul className="flex flex-col gap-y-1">
                ...
                <div className="grid grid-cols-2 gap-2">
                    {PopularSizes.map((size) => {
                        ...
                        const isChecked = filters.aspects.some(aspect => aspect.height === height && aspect.width === width);
                        return <Checkbox checked={isChecked} key={size} title={size} onChange={(checked:boolean)=>{
                            if(checked){
                                setFilters((originalFilters) => {
                                    return {
                                        ...originalFilters,
            ...
            <ul className="flex flex-col gap-y-1">
                ...
                <div className="grid grid-cols-2 gap-2">
                    {Object.values(Color).map((color) => {
                        ...
                        return <Checkbox checked={isChecked} key={color} title={color} onChange={(checked:boolean)=>{
                            if(checked){
                                setFilters((originalFilters) => {
                                    return {
                                        ...originalFilters,
